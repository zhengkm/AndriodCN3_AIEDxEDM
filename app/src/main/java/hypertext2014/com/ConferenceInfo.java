...
public class ConferenceInfo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		wv1 = (WebView)this.findViewById(R.id.WebView01);
		wv1.getSettings().setJavaScriptEnabled(true);
		wv1.loadData(Conference.description, "text/html", "utf-8");

//		wv2 = (WebView)this.findViewById(R.id.WebView02);
//		wv2.getSettings().setJavaScriptEnabled(true);
//		wv2.loadData(Conference.description.substring(Conference.description.indexOf("@")+1,Conference.description.length()), "text/html", "utf-8");
