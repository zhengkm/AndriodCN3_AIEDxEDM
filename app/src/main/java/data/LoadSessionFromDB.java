    ...
    private class SessionParseHandler extends DefaultHandler {
        ...
        public void endElement(String namespaceURI, String localName,
            ...
            if (localName.equals("sessionDate")) {
                ...
                Date date = new Date();
                try {
                    date = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.S").parse(sb.toString());
            ...
            if (localName.equals("beginTime") && sessionStart == true) {
                ...
                Date date1 = new Date();
                try {
                    date1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.S").parse(sb.toString());
                } catch (ParseException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
            ...
            if (localName.equals("endTime") && sessionStart == true) {
                ...
                Date date2 = new Date();
                try {
                    date2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.S").parse(sb.toString());
                } catch (ParseException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
