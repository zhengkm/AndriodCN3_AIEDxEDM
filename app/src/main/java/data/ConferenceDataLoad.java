...
public class ConferenceDataLoad {
	...
	private Conference confere = new Conference();
	...
	public void loadConferenceInfo() {
		...
		try {
			...
			JSONObject h=json.getJSONObject(0);

			confere.title=h.getString("shortTitle");

			confere.startDate =Datetrans.get(h.getString("beginDate").substring(0, 10));

			confere.endDate = Datetrans.get(h.getString("endDate").substring(0,10));

			confere.description=h.getString("abstract");

			confere.location=h.getString("location");
...
//	public void loadConferenceInfo() {
//		Conference.title = "AIED 2015 x EDM 2015";
//		Conference.startDate = "Monday, Jun.22 ";
//		Conference.description ="AIED is the next in a longstanding series of biennial international conferences for high quality research in intelligent systems and cognitive science for educational computing applications. The conference provides opportunities for the cross-fertilization of approaches, techniques and ideas from the many fields that comprise AIED, including computer science, cognitive and learning sciences, education, as well as many domain-specific areas.@The EDM conference is a leading international forum for high-quality research that mines large data sets in order to answer educational research questions that shed light on the learning processes. These data may come from the traces that students leave when they interact with learning management systems, interactive learning environments, intelligent tutoring systems, educational games or when they participate in a data-rich learning context. The types of data range from raw log files to eye-tracking devices and other sensor data.";
//		Conference.endDate = "Monday, Jun.29 ";
//		Conference.location = "Madrid, Spanish ";
//
//	}
//
